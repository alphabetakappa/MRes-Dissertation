...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Background}
This section aims to introduce the emergent behaviour of interest in the financial markets, how recurrence relations and agent-based models can be used to model it. A short literature review showing the absence of work using agent-based models within finance, and a description of a select agent-based model that has been designed for the financial markets. 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Emergent Behaviour}
%what is emegent bejvioru?
%who cares, and why do they care? (regurlators and govements, lose a lot of money) (since the financial amrekts are super complex it is a fair assumtion that emegrence may take place in them, if this is the case, negartive emergent behviour could take plave in the markets. This could cause the markets to become quickly unstable or act in unexpexcted ways. This is something that regualrtors want to know about, they want to stop the markets being unstable or doing very unexpecte things, espcially if people can manpulate the markets into doing this. Therefore research into emegrnce is very useful)
%what are some examples of emergent behviour in finance (a number of things have been noted as possible emeegnce in the markets, most notable flash crashes)
%discrete emergnt behviour (of particalar interest for regulators is HFTs and they are damn fast, so time is discrete)
