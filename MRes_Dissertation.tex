...
%2rewrite subsections of translation 

%3rewrite conclusion x2 the size

%%%%%%%%%%finish%%%%%%%%%%%%%

%4write conversion code. Lexer, parser, first step


%%%%%%%%%%%add%%%%%%%%%%%%%%%%%

%5in numeric testing add a table with the input values tested and the outputs for each step (change miranda code)
%Input | inintial | step1 | step2 | step3 | step4 | step5 | step6 | step7 | step8
% 0      | ans ...
% 1
% 3
% 10
...
\begin{abstract}
\noindent {\it 
This dissertation investigates a process to increase the acceptance of agent-based models by sceptics, who are familiar with recurrence relation models. The work presented in this dissertation is designed to combat two main aspects that hinder the up take in agent-based models by these sceptics, a lack of a model wide formalism and a lack of familiarity to those unaccustomed to the technique. 

The importance of this work relates in particular to the field of economics, where agent-based models are yet to become widely accepted. This lack of acceptance leads to an absences of work based on agent-based models in top economics journals. This creates a problem for modelling complex systems and emergent behaviour, as agent-based models are in many cases a natural modelling technique for these systems, due in part to their message passing.  

The process presented in this dissertation is to create an agent-based model equivalent to recurrence relation model, recurrence relation models are both widely accepted and have a model wide formalisation. Creating an equivalence between these two models allows for the recurrence relation model to give the agent-based model both a formalisation and a familiar model, which sceptics can view it from.       

This work comprises of the creation of a bespoke recurrence relation language, the design of step-by-step translation between the models, and numeric testing of the equivalence of these models. 

The bespoke recurrence relation language presented allows for an experiment involving complex and interacting system to be laid out in a clear manner, using recurrence relations. 
...
%talk about this process in more detail 

%autamted translated testing, 
%we show below it is shown how this is achived 
