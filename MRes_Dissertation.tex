...
%1add in intro a bullet list of objectives or planned contributions of the project & in conclusion add a bulleted list of objects that have been achieved
...
%14code and make sure it works  (using endwhere now and new parse tree)
