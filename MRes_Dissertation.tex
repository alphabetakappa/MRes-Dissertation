...
%why we need bespoke recurrance relation language, need to read this into a computer therofore need to desiced how people write it

%what are the considerations needed to design this language (minumial as possible)
%-must be usable by non computer scientist, mathimatiants, exonimists
%-still has to contain all the information needed to specify the program
%-have to be able to define different players
%-if else statements
%-spefy an expemrent 
%-varibles
%-where blocks (make things neater)
%-equations with inputs
%-lists
%-mathmitcal opertions 
%-hd
%-tl
%-:
