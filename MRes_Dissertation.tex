...
%tell chris to look at my new section "Method for Achieving a Translation" as I have changed it a bit to hopefully cover the issues he had 

%look at line help

%tell chris i have rewritten bespoke rr 
...
\subsection{Syntax}
%in bespoke model say that miranda as shown is the definition of the language 
%the meaning of the recurraance relation is this miranda expression, when defining mirada expression 
