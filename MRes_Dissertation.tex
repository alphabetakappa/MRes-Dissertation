...
%1make sure appendixes match the paper 



%%%%%%%%%%rewrite%%%%%%%%%%%%

%about using miranda for giving numerical equivlance (talk about a program to translate and the afcet tthat this is the defintion so its fine) 


%%%%%%%%%%finish%%%%%%%%%%%%%

%2create transformation program 
...
\newpage 
\section*{Appendix A: Programs for Numerical Testing}
\addcontentsline{toc}{section}{Appendix A: Programs for Numerical Testing}
\subsection*{User Manual}
Here the code that translates from the target states in the design steps shown in this dissertation is given, along with its results. These results were used to numerically test the design steps equivalency. 
...
\subsection*{Programs for Numerical Testing}
