...
\begin{document} 
\title{Design of A Conversion of both Semantics and Representation between Agent-Based Models and Recurrence Relations}
...
Syntax analysis takes this list of tokens and stores it in a parse tree that enforces structure. This parse tree can be seen in Fig.~\ref{fig:parsetreecode}.  
...
\begin{figure}[H]
	\centering
	\lstinputlisting[language=Miranda]{RRiloc.m}
...
\begin{figure}[H]
	\centering
	\lstinputlisting[language=Miranda]{RRwfc.m}
...
\begin{figure}[H]
	\centering
	\lstinputlisting[language=Miranda]{RRhc.m}
	\caption{\it Recurrence relations with with wrapper functions.}
	\label{fig:RRhc}
\end{figure} 
