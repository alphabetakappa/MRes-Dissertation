...
\end{itemize}
%not all the problems have to be over come: the aim of this paper is to aquaint econmist with abm and hence the proof of every type of rr model is not needed, only enough to get an understanding. then abm can just do there things
%this combats the idea that certain situations most statiscal representations are very diffcult to translate into an agent based model 
