...
\begin{itemize}
  ...
  \item Important: in hypotheses formalisation, communicate between fields with different expertise like science and economics,  lot of good publish work has been done that hasn't resonated with economists so can be used to normalise the approach, 
...
\subsubsection{Review of Literature on Financial Model}
